...
export interface BehaviorModel<T extends LocalStore> { readonly store: T; }
...
// BehaviorModelをどういう単位で作るかを再考する
// ✕ 画面単位
// ◯ DoaminModelのような単位

export function createBehaviorModels(): BehaviorModels {
...
export const BEHAVIOR_MODELS_KEY = Symbol("BehaviorModels") as InjectionKey<BehaviorModels>;
